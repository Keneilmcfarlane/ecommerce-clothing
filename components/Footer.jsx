  ...
  return (
    <footer>
      <div className='footer'>
        <div className='logo'>
          <Image src={logo} width={190} height={100} alt='logo' />
      ...
      <div className='copyright'>
        <p>Copyright © 2024 Fashion Trend</p>
        <p>Design by. <span>Keneil Mcfarlane</span></p>
        <p>Code by. <span>Keneil Mcfarlane on github</span></p>
      </div>
    </footer>
  )
}
